 ...
 * @returns {Promise<object,string>}
 */
Gab.prototype.followers = (username, before = 0) => {
  return new Promise(resolve => {
 ...
 * @returns {Promise<object,string>}
 */
Gab.prototype.following = (username, before = 0) => {
  return new Promise(resolve => {
 ...
 * @returns {Promise<object,string>}
 */
Gab.prototype.notifications = (before = 0) => {
  return new Promise(resolve => {
 ...
 * @returns {Promise<object,string>}
 */
Gab.prototype.userFeed = (username, before = '') => {
  return new Promise(resolve => {
 ...
 * @returns {Promise<object,string>}
 */
Gab.prototype.removeUpvote = postId => {
  return new Promise(resolve => {
    const url = `posts/${postId}/upvote`;
 ...
 * @returns {Promise<object,string>}
 */
Gab.prototype.removeDownvote = postId => {
  return new Promise(resolve => {
    const url = `posts/${postId}/downvote`;
 ...
 * @returns {Promise<object,string>}
 */
Gab.prototype.removeRepost = postId => {
  return new Promise(resolve => {
    const url = `posts/${postId}/repost`;
 ...
 * @returns {Promise<object,string>}
 */
Gab.prototype.postDetails = postId => {
  return new Promise(resolve => {
 ...
 * @returns {Promise<object,string>}
 */
Gab.prototype.groupDetails = groupId => {
  return new Promise(resolve => {
 ...
 * @returns {Promise<object,string>}
 */
Gab.prototype.groupUsers = (groupId, before = 0) => {
  return new Promise(resolve => {
 ...
 * @returns {Promise<object,string>}
 */
Gab.prototype.groupModerationLogs = groupId => {
  return new Promise(resolve => {
 ...
 * @returns {Promise<object,string>}
 */
Gab.prototype.createMediaAttachment = file => {
  return new Promise(resolve => {
 ...
 * @returns {Promise<object,string>}
 */
Gab.prototype.createPost = options => {
  return new Promise(resolve => {
    const url = `posts`;
